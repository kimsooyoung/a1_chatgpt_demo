...
parser.add_argument("--prompt", type=str, default="/home/jm/unitree_ws/src/a1_chatgpt_demo/src/unitree_sys.txt")
parser.add_argument("--sysprompt", type=str, default="/home/jm/unitree_ws/src/a1_chatgpt_demo/src/unitree_basic.txt")
args = parser.parse_args()

with open('/home/jm/unitree_ws/src/a1_chatgpt_demo/src/config.json', 'r',encoding='UTF8') as f:
    config = json.load(f)
