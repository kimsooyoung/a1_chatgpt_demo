...
class WaypointCtrl(object):
    ...
    def gpt_callback(self, msg):
        ...
        self.waypoint_pose = np.array(msg.data)
    ...
    def move(self):
        ...
        if self.moving_mode == "initial":
            ...
            # print("Start Moving to the waypoint")
...
def target_waypoint():
    ...
    rospy.init_node("waypoint_control_node", anonymous=True)
    waypoint_control = WaypointCtrl()
